...
class AskomicsPositionableLink extends AskomicsLink {
  ...
  buildConstraintsSPARQL() {
    ...
    if (this.same_ref) {
      blockConstraint.push("?"+'URI'+node.SPARQLid+" "+ "displaySetting:IsIncludeInRef"+" "+s );
      blockConstraint.push("?"+'URI'+secondNode.SPARQLid+" "+ "displaySetting:IsIncludeInRef"+" "+ s);
    } else {
      blockConstraint.push("?"+'URI'+node.SPARQLid+" "+ "displaySetting:IsIncludeIn"+" "+ s);
      blockConstraint.push("?"+'URI'+secondNode.SPARQLid+" "+ "displaySetting:IsIncludeIn"+" "+ s);
    }
    ...
    if (this.same_tax) {
      ...
      if ( att1 === null && att2 === null) {
        blockConstraint.push("?"+'URI'+node.SPARQLid+" "+ "displaySetting:position_taxon"+" "+ "?taxon_"+node.SPARQLid+secondNode.SPARQLid);
        blockConstraint.push("?"+'URI'+secondNode.SPARQLid+" "+ "displaySetting:position_taxon"+" "+ "?taxon_"+node.SPARQLid+secondNode.SPARQLid);
      } else if ( att1 === null ) {
        blockConstraint.push("?"+'URI'+node.SPARQLid+" "+ "displaySetting:position_taxon"+" "+ "?"+att2);
      } else if ( att2 === null ) {
        blockConstraint.push("?"+'URI'+secondNode.SPARQLid+" "+ "displaySetting:position_taxon"+" "+ "?"+att1);
      } else {
        blockConstraint.push("FILTER ( "+ "?"+att1+"="+"?"+att2+" )");
      }
    }
    ...
    if (this.which_strand == "same" ) {
      ...
      if ( att1 === null && att2 === null) {
        blockConstraint.push("?"+'URI'+node.SPARQLid+" "+ "displaySetting:position_strand"+" "+ "?strand_"+node.SPARQLid+secondNode.SPARQLid);
        blockConstraint.push("?"+'URI'+secondNode.SPARQLid+" "+ "displaySetting:position_strand"+" "+ "?strand_"+node.SPARQLid+secondNode.SPARQLid);
      } else if ( att1 === null ) {
        blockConstraint.push("?"+'URI'+node.SPARQLid+" "+ "displaySetting:position_strand"+" "+ "?"+att2);
      } else if ( att2 === null ) {
        blockConstraint.push("?"+'URI'+secondNode.SPARQLid+" "+ "displaySetting:position_strand"+" "+ "?"+att1);
      } else {
        blockConstraint.push("FILTER ( "+ "?"+att1+"="+"?"+att2+" )");
      }
    }
